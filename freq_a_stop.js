...
class TimelineItem {
    constructor(name,child_id,seconds,freq,speed,speed_a,freq_a,freq_overtone,speed_overtone,freq_a_stop) {
        this.name = name
...
function setValues(timelineItem,circles) {
    console.log(timelineItem.freq_a_stop)
    setTimeout(function() {
